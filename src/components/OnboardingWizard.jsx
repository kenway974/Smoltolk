...
// IMPORTANT : ces libellés doivent correspondre EXACTEMENT au champ `profil`
// des situations (src/data/situations.js). C'est ce qui garantit que la
// personne choisie renvoie uniquement SES conversations, sans débordement.
const PROFILE_CATEGORIES = [
  {
    header: "💘 Séduction & Rencontres",
    profiles: [
      "Fille à aborder",
      "Garçon à aborder",
      "Inconnu(e) attirant(e)",
      "Inconnu(e) avec un style remarquable",
      "Inconnu(e) au bar",
      "Inconnu(e) en marge du groupe",
      "Inconnu(e) près de vous",
      "Inconnu(e) avec un livre",
      "Inconnu(e) studieux(se)",
      "Inconnu(e) assis à côté",
      "Visiteur(euse) seul(e)",
      "Ami(e) d'ami(e)",
      "Client(e)",
    ],
  },
  {
    ...
    profiles: [
      ...
      "Collègue Senior",
      "Collègue de déjeuner",
      "Manager / Boss",
      "Recruteur(euse)",
      "Stagiaire",
      "Participant(e) en réunion",
      "Participant(e) inconnu(e)",
    ],
  },
  {
    ...
    profiles: [
      "Coach sportif",
      "Partenaire de sport",
      "Inconnu(e) sur les machines",
      "Participant(e) au cours",
      "Nageur / Nageuse",
      "Joueur / Joueuse",
      "Grimpeur / Grimpeuse",
      "Kiné / Médecin",
  ...
  {
    header: "🚇 Transports & Route",
    profiles: [
      "Voisin(e) de siège",
      "Voisin(e) de compartiment",
      "Chauffeur VTC / Taxi",
      "Automobiliste",
    ],
  },
  {
    header: "🛍️ Commerces & Services",
    profiles: [
      "Barista / Serveur",
      "Caissier/ière",
      "Vendeur(euse)",
  ...
  {
    header: "🏙️ Vie de quartier",
    profiles: [
      "Voisin(e) dans l'ascenseur",
      "Gardien / Concierge",
      ...
      "SDF",
      "Laveur de vitres",
      "Inconnu(e) dans le rayon",
      "Inconnu(e) qui attend",
      "Inconnu(e) juste derrière",
      "Inconnu(e) qui cherche son chemin",
    ],
  },
  {

    ...
    <div className="px-4 pb-8 flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-1">
        <div className="flex items-center gap-2.5">
          <span className="flex items-center justify-center w-9 h-9 rounded-2xl bg-blue-100 text-blue-600">
            <MapPin size={18} strokeWidth={2.5} />
          </span>
          <h2 className="text-2xl font-black text-stone-900 tracking-tight">Où es-tu&nbsp;?</h2>
        </div>
        <p className="text-sm text-stone-500 ml-11">
          Choisis l'endroit où tu te trouves
        </p>
      </div>
        ...
        {options.map((lieu) => {
          ...
          return (
            <button
              ...
              className={`flex items-center justify-center px-4 py-3.5 rounded-2xl border-2 font-bold text-sm transition-all duration-200 active:scale-95 ${
                isActive

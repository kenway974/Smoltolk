...
import { ArrowLeft, ChevronDown, ArrowRight, Compass, BookOpen } from "lucide-react";
...
function Blocage({ index, objection, tag, croyance, realite, action, cta }) {
    ...
    <div className="min-h-svh">
      ...
      <div className="px-5 pb-16 pt-6 max-w-[720px] mx-auto">
        ...
        <div className="flex flex-col gap-3">
          {BLOCAGES.map((b, i) => <Blocage key={i} index={i} {...b} />)}
        </div>
